...
from BADMUSIC import Bad, app, db, lang, queue, tg, yt
...
async def _controls(_, query: types.CallbackQuery):
    ...
    if action == "pause":
        ...
        return await Bad.play_media(chat_id, msg, media)

    elif action == "replay":
        media = queue.get_current(chat_id)
        media.user = user
        await Bad.replay(chat_id)
